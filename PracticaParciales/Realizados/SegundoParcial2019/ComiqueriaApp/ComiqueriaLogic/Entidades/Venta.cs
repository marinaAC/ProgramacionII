...
namespace ComiqueriaLogic
{
    ...
    public sealed class Venta
    {
        ...
        private void Vender(int cantidad)
        {
            ...
            Serializador<Venta>.SerializarXml(this,String.Format("{0}.xml",this.Producto.Descripcion));
            Serializador<Venta>.SerializarBinario(this, this.producto.Descripcion);
        }
        ...
        {
            return String.Format("{0} - {1} - {2}", this.fecha, this.producto.Descripcion, ExtensionNumerica.FormatearPrecio(this.precioFinal));
        }        
    }
}
