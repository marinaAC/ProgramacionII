...
namespace _2016.Formatos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0:.0} - {1:#.00} - {2:0.000} - {3} {4} ", 10.476864, 0.3558742, 0.9214, 96.3352587, mivariable);
            ...
            Console.WriteLine("{0:X} - {1:E} - {2:C} - {3:D10}", 16, 15355.8742, 963352587, 85632);
